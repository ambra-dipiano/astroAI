...
def main(configuration):
    ...
    ds = process_dataset(src_dataset_path, bkg_dataset_path, trange, conf['binning'], conf['smoothing'], conf['src_sample'], conf['bkg_sample'], save=True, output=conf['directory'])
